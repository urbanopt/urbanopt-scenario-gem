...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'openstudio-common-measures', '~> 0.2'
  spec.add_runtime_dependency 'openstudio-model-articulation', '~> 0.2'
  spec.add_runtime_dependency 'sqlite3', '1.4.2'
  spec.add_runtime_dependency 'urbanopt-core', '~> 0.3'
  spec.add_runtime_dependency 'urbanopt-reporting', '~> 0.1'
  spec.add_runtime_dependency 'openstudio-load-flexibility-measures', '~> 0.1'
  spec.add_runtime_dependency 'openstudio-extension', '~> 0.2'
end
